...
public class Read implements JMC{
    ...
    */ 
     ...
     * @return          Score read from file, or null if an error occured
     *
     * @see #midiOrJmWithNoMessaging(java.io.File)
     */
     ...
     * @return      Score read from file, or null if an error occured
     *
     * @see #midiOrJmWithAWTMessaging(String, String, java.awt.Frame)
     */
     ...
     * @return          Score read from file, or null if an error occured
     *
     * @see #midiOrJmWithAWTMessaging(java.io.File, java.awt.Frame)
     */
    ...
    /**
     * Displays an error message in a {@link java.awt.Dialog}.  The message displayed is
     ...
     * If the owner is a Dialog use {@link #displayErrorDialog(java.awt.Dialog)} instead.
     *
     * @param owner     Frame whose control is to be suspended while the error
     *                 messages are displayed
     * @param message   String to be displayed
     *
     * @see displayErrorDialog( java.awt.Frame)
     * @see #midiOrJmWithAWTMessaging(java.io.File, java.awt.Dialog);
     * @see #midiOrJmWithAWTMessaging(String, String, java.awt.Dialog);
     */
     ...
     * method is executed by both {@link displayErrorDialog( java.awt.Frame)} and {@link
     * dispayedErrorDialog( java.awt.Dialog)} and stores the code common to both.
     *
     ...
     * @return      Score read from file, or null if an error occured
     *
     * @see #midiOrJmWithSwingMessaging(String, String, java.awt.Component)
     */
     ...
     * @return          Score read from file, or null if an error occured
     *
     * @see #midiOrJmWithSwingMessaging(java.io.File, java.awt.Component)
     */
