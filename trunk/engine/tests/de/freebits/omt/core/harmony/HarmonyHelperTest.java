...
/**
 * Test Cases for the {@link de.freebits.omt.core.harmony.HarmonyHelper} class.
 * 
...
public class HarmonyHelperTest {
	...
	/**
	 * Test method for {@link de.freebits.omt.core.harmony.HarmonyHelper#getScaleByHarmony(byte[], int)}
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link de.freebits.omt.core.harmony.HarmonyHelper#isNoteInScale(jm.music.data.Note, byte[])}
	 */
	@Test
	...
	/**
	 * Test method for {@link de.freebits.omt.core.harmony.HarmonyHelper#isNoteNeighbor(jm.music.data.Note, jm.music.d
		  ata.Note, byte[])}
	 */
	@Test
