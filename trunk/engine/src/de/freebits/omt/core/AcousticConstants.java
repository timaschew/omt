...
public interface AcousticConstants {
    ...
    /**
     * Minimum playable note duration.
     *
     * @see <a href="http://de.wikipedia.org/wiki/Liberace">Wikipedia: Fastest Piano Player</a>
     * playing 6.000 notes in 2 seconds
     */
    public static final double MIN_PLAYABLE_NOTE_DURATION = 0.02;
}
